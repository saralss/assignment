  ...
  return (
    <div>
        ...
        <div className='flex m-4 p-4 items-center'>
            <div className='bg-green-200 w-[50%] h-72  text-black font-mono font-bold text-center bg-gradient-to-r from-pink-200 via-purple-500 to-blue-500 bg-[length:400%_400%] shadow-lg rounded-lg'>Computer
            ...
            <div className='bg-green-200 w-[50%] h-72 text-black font-mono font-bold text-center bg-gradient-to-r from-blue-200 via-purple-500 to-red-500 bg-[length:400%_400%] ml-4 rounded-lg' >You 
